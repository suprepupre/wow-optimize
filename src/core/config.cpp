...
static const BoolSetting kBoolSettings[] = {
    ...
    { "Graphics_Sound", "ShadowBufferAlternate", &Settings::OptShadowBufferAlternate },
...
static const int kBoolSettingCount = (int)(sizeof(kBoolSettings) / sizeof(kBoolSettings[0]));
    ...
    void Load() {
        ...
        g_settings.OptShadowBufferAlternate = GetPrivateProfileIntA("Graphics_Sound", "ShadowBufferAlternate", 0, iniPath.c_str()) != 0;
